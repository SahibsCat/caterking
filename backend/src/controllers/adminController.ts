...
export const createBulkMenuItems = async (req: Request, res: Response) => {
  try {
...
export const getMealPacks = async (req: Request, res: Response) => {
  try {
...
export const createMealPack = async (req: Request, res: Response) => {
  try {
...
export const updateMealPack = async (req: Request, res: Response) => {
  try {
...
export const deleteMealPack = async (req: Request, res: Response) => {
  try {
...
// Bulk Menu Actions
export const bulkToggleMenuItems = async (req: Request, res: Response) => {
  try {
...
export const bulkToggleMealPacks = async (req: Request, res: Response) => {
  try {
    const { ids, is_active } = req.body;
...
export const bulkDeleteMealPacks = async (req: Request, res: Response) => {
  try {
    const { ids } = req.body;
...
export const createAvailableDate = async (req: Request, res: Response) => {
  try {
    const { date } = req.body;
    const exists = await AvailableDate.findOne({ date: new Date(date) });
    if (exists) return res.status(400).json({ message: 'Date already exists' });
...
export const deleteAvailableDate = async (req: Request, res: Response) => {
  try {
...
export const bulkDeleteAvailableDates = async (req: Request, res: Response) => {
  try {
    const { ids } = req.body;
    await AvailableDate.deleteMany({ _id: { $in: ids } });
...
export const bulkCreateAvailableDates = async (req: Request, res: Response) => {
  try {
...
export const getOccasionMenus = async (req: Request, res: Response) => {
  try {
...
export const getOccasionMenuByQuery = async (req: Request, res: Response) => {
  try {
    ...
    const menu = await OccasionMenu.findOne({ occasion, package: pkg })
      .populate('items.itemId');
    if (!menu) return res.status(404).json({ message: 'No default menu found for this combination' });
    res.json(menu);
  } catch (error: any) {
    res.status(500).json({ message: error.message });
  }
...
export const createOccasionMenu = async (req: Request, res: Response) => {
  try {
...
export const updateOccasionMenu = async (req: Request, res: Response) => {
  try {
...
export const deleteOccasionMenu = async (req: Request, res: Response) => {
  try {
...
export const bulkCreateOccasionMenus = async (req: Request, res: Response) => {
  try {
...
export const getMealBoxMenus = async (req: Request, res: Response) => {
  try {
...
export const getMealBoxMenuByQuery = async (req: Request, res: Response) => {
  try {
    const boxType = req.query.type as string; // 'Adult', 'Kids', 'Snack'
    const pkg = req.query.package as string; // 'Standard', 'Premium', 'Elite'
    const menu = await MealBoxMenu.findOne({ boxType, package: pkg })
      .populate('items.itemId');
    if (!menu) return res.status(404).json({ message: 'No configuration found for this meal box' });
    res.json(menu);
  } catch (error: any) {
    res.status(500).json({ message: error.message });
  }
...
export const createMealBoxMenu = async (req: Request, res: Response) => {
  try {
...
export const updateMealBoxMenu = async (req: Request, res: Response) => {
  try {
    const menu = await MealBoxMenu.findByIdAndUpdate(req.params.id, req.body, { new: true });
    if (!menu) return res.status(404).json({ message: 'Configuration not found' });
    res.json(menu);
  } catch (error: any) {
    res.status(400).json({ message: error.message });
  }
...
export const deleteMealBoxMenu = async (req: Request, res: Response) => {
  try {
...
export const bulkCreateMealBoxMenus = async (req: Request, res: Response) => {
  try {
